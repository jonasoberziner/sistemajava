...
public class TestaHeranca {
    ...
    public static void main(String args[]) {
        ...
        ContaEspecial contaEsp1 = new ContaEspecial(1000, 2000, "98989898", cliente1, ag1);

        ContaEspecial contaEsp2 = new ContaEspecial(500, 3000, "232323", cliente2, ag1);

        ContaPoupanca contaPoup = new ContaPoupanca("11/11/2000", 800, "232323", cliente2, ag1);
